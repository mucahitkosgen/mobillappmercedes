...
import 'package:mobilappmercedes/widgets/profile_widget/profileflowcard.dart';

import '../edit_profile.dart';

class ProfilePostFlow extends StatefulWidget {
  @override
  _ProfilePostFlow createState() => _ProfilePostFlow();
}

class _ProfilePostFlow extends State<ProfilePostFlow> {
                ...
                return InkWell(
                    ...
                    child: Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) => ProfileFlowCard(
